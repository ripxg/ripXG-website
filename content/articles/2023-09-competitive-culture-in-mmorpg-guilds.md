...
The second system designed was based on rewarding **attendance**. In the theme of fairness for contribution, we sought to use something loosely based on [Dragon Kill Points](https://en.wikipedia.org/wiki/Dragon_kill_points) which would give members points for attendance based on their gear level.
