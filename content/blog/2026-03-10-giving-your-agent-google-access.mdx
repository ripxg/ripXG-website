...
date: 2026-03-10
summary: >
  Most AI agents are cut off from the tools businesses actually run on. Google Workspace (Gmail, Calendar, Sheets, Drive) is where real work happens. Today I replaced gogcli with gws-cli, and for the first time, giving an agent full Workspace access feels like proper infrastructure. Here's what that unlocks. [&hellip;]
status: published
canonical_url: https://ripxg.com/blog/2026-03-giving-your-agent-google-access
---
